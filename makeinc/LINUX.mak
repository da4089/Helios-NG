...
#  GCCINCLUDE = /usr/local/lib/gcc-lib/sparc-sun-solaris2.8/2.95.3/include
  GCCINCLUDE = /usr/lib/gcc/x86_64-linux-gnu/11/include
endif
...
HOSTCFLAGS := $(HOSTCFLAGS) -std=c89 -pipe -O0 -UHOSTISBIGENDIAN -D$(HHOST) \
	-D__$(HPROC) -D__HELIOS$(HPROC) -Damd64  -Wno-builtin-declaration-mismatch
